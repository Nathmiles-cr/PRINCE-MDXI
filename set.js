...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~5KuHr6jEHI3ENCV4iMwu", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "255616442010,255759112010", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "255616442010", // Only 1 owner Number Here, others Add to sudo numbers...
